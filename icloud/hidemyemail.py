...
class HideMyEmail:
    ...
    def __init__(self, label: str = "zrxmax's gen", cookies: str = ""):
        ...
        """
        # Label that will be set for all emails generated, defaults to `zrxmax's gen`
        self.label = label
    ...
    async def reserve_email(self, email: str) -> dict:
        ...
        try:
            payload = {
                "hme": email,
                "label": self.label,
                "note": "Generated by zrxmax's iCloud email generator",
            }
            async with self.s.post(
